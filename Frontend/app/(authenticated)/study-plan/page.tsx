...
import { mockStudyBlocks } from "@/lib/mock-data";
      ...
      <div className="flex-1 overflow-y-auto p-lg lg:p-xl custom-scrollbar relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          ...
          <div className="flex gap-3">
            <motion.button 
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 bg-primary text-white font-bold rounded-lg hover:opacity-90 transition-colors flex items-center gap-2"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter pb-10">
          ...
          >
            <DayCard day="Mon" date="Oct 16" blocks={mockStudyBlocks.slice(0, 1)} />
            <DayCard day="Tue" date="Oct 17" isToday={true} blocks={mockStudyBlocks} />
            <DayCard day="Wed" date="Oct 18" blocks={mockStudyBlocks.slice(1, 3)} />
            <DayCard day="Thu" date="Oct 19" blocks={mockStudyBlocks.slice(0, 1)} />
            <DayCard day="Fri" date="Oct 20" blocks={mockStudyBlocks.slice(2)} />
          </motion.section>
