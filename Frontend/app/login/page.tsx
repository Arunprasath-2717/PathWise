      ...
      <div className="min-h-screen w-full flex items-center justify-center p-md relative overflow-hidden bg-background">
        ...
        <main className="w-full max-w-[440px] z-10">
          ...
          <div className="bg-surface-container-lowest border border-bordermist rounded-xl p-xl shadow-none transition-all duration-300">
            ...
            {error && (
              <div className="mb-lg p-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm text-center">
                {error}
              </div>
            )}
            ...
            <form className="space-y-lg" onSubmit={handleLogin}>
              ...
              <div className="space-y-xs">
                ...
                <div className="relative group">
                  ...
                  <input 
                    className="w-full h-12 pl-12 pr-12 bg-white border border-bordermist rounded-lg font-body-md text-body-md text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" 
                    id="password" 
                    placeholder="••••••••" 
              ...
              <motion.button 
                ...
                disabled={loading}
                whileTap={{ scale: 0.98 }}
                className="w-full h-12 bg-[#2F6FB0] text-white rounded-lg font-label-md text-label-md flex items-center justify-center gap-2 hover:opacity-90 transition-all mt-6 disabled:opacity-60"
              >
                {loading ? (
